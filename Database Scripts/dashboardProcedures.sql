...
ALTER PROCEDURE [dbo].[getURLbyGroupIdAndSection]
	...
	@section varchar(50)
AS
	SELECT dashboard_urls.url_name, dashboard_urls.url_address FROM dashboard_urls
	...
	WHERE dashboard_groups.group_id = @groupid AND dashboard_urls.url_section = @section
